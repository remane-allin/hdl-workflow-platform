...
CREATE TABLE IF NOT EXISTS uvm_guide_documents (
    doc_id TEXT PRIMARY KEY,
    title TEXT,
    vendor TEXT,
    tool_version TEXT,
...
CREATE TABLE IF NOT EXISTS uvm_guide_sections (
...
CREATE INDEX IF NOT EXISTS idx_uvm_guide_sections_doc ON uvm_guide_sections(doc_id);
CREATE INDEX IF NOT EXISTS idx_uvm_guide_sections_anchor ON uvm_guide_sections(anchor);

CREATE TABLE IF NOT EXISTS uvm_guide_chunks (
    chunk_id TEXT PRIMARY KEY,
    doc_id TEXT NOT NULL,
    domain TEXT,
    tool TEXT,
...
CREATE INDEX IF NOT EXISTS idx_uvm_guide_chunks_doc ON uvm_guide_chunks(doc_id);
CREATE INDEX IF NOT EXISTS idx_uvm_guide_chunks_page ON uvm_guide_chunks(page_start);

CREATE VIRTUAL TABLE IF NOT EXISTS uvm_guide_chunks_fts USING fts5(
    chunk_id UNINDEXED,
    doc_id UNINDEXED,
    tool_version UNINDEXED,
    anchor UNINDEXED,
...
CREATE TABLE IF NOT EXISTS uvm_guide_examples (
...
CREATE INDEX IF NOT EXISTS idx_uvm_guide_examples_doc ON uvm_guide_examples(doc_id);
CREATE INDEX IF NOT EXISTS idx_uvm_guide_examples_page ON uvm_guide_examples(page);
