...
6. Link parsed outputs from `lib/parsed/fpga_io_tables/` into the relevant project memory or report when used.
...
Raw spreadsheets stay in `lib/files/fpga_io_tables/`. Curated reusable connection guidance should be summarized here or in a related schematic pattern entry.
