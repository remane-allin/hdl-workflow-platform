...
scoreboard/reference model check legal behavior from `work/docparse/structured_spec`
...
remain under `output/uvm/` in a Loop2-ready project. Generate real
project-specific sources before running
`work/loop2_uvm/sim/uvm_full_functional.do` as an entry check, then
`work/loop2_uvm/sim/regression.do` for final evidence.
