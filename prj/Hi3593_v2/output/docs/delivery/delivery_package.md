...
| verification | loop1_gate=FAIL; loop1_manifest=not recorded; loop2_gate=FAIL; loop2_manifest=not recorded; loop3_gate=FAIL; loop3_manifest=not recorded; final_gate=PASS; final_report=output/reports/final_audit_report.md |
