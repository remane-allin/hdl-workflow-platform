...
- generated_at: 2026-06-26T22:25:29
- project: Hi3593_v2
...
| docset_sync | FAIL | output/docs/manifests/application_doc_manifest.json source drift: work/docparse/prototype/prototype_plan.yaml; output/docs/manifests/application_doc_manifest.json source drift: work/docparse/trace_matrix/req_to_design_intent.yaml; output/docs/manifests/application_doc_manifest.json source drift: work/docparse/trace_matrix/req_to_test_intent.yaml; output/docs/manifests/application_doc_manifest.json source drift: work/gates/gate_status.json; output/docs/manifests/delivery_doc_manifest.json source drift: work/docparse/prototype/prototype_plan.yaml; output/docs/manifests/delivery_doc_manifest.json source drift: work/docparse/trace_matrix/req_to_design_intent.yaml; output/docs/manifests/delivery_doc_manifest.json source drift: work/docparse/trace_matrix/req_to_test_intent.yaml; output/docs/manifests/delivery_doc_manifest.json source drift: work/gates/gate_status.json; output/docs/manifests/microarchitecture_doc_manifest.json source drift: work/docparse/prototype/prototype_plan.yaml; output/docs/manifests/microarchitecture_doc_manifest.json source drift: work/docparse/trace_matrix/req_to_design_intent.yaml; output/docs/manifests/microarchitecture_doc_manifest.json source drift: work/docparse/trace_matrix/req_to_test_intent.yaml; output/docs/manifests/microarchitecture_doc_manifest.json source drift: work/gates/gate_status.json; output/docs/manifests/verification_doc_manifest.json source drift: work/docparse/prototype/prototype_plan.yaml; output/docs/manifests/verification_doc_manifest.json source drift: work/docparse/trace_matrix/req_to_design_intent.yaml; output/docs/manifests/verification_doc_manifest.json source drift: work/docparse/trace_matrix/req_to_test_intent.yaml; output/docs/manifests/verification_doc_manifest.json source drift: work/gates/gate_status.json |
