...
- generated_at: 2026-06-29T23:21:37
- project: Hi3593_v2
...
| prerequisite:work/loop2_uvm | PASS | work\memory\recovery\rollback_manifests\work_loop2_uvm_develop_20260629232106.json |
| docset_sync | FAIL | output/docs/manifests/application_doc_manifest.json source drift: work/gates/gate_status.json; output/docs/manifests/delivery_doc_manifest.json source drift: work/gates/gate_status.json; output/docs/manifests/microarchitecture_doc_manifest.json source drift: work/gates/gate_status.json; output/docs/manifests/verification_doc_manifest.json source drift: work/gates/gate_status.json |
...
| artifact_hash_drift | PASS | 4 source hash change(s) are covered by CR-20260626224447-complete-hi3593-digital-functional-cover impact artifacts |
| skill_policy_hash_drift | PASS | skill hashes match previous gate manifest work_loop3_fpga_proto_develop_20260626224036.json |
| protected_gate_hash_drift | PASS | protected gate files match previous manifest work_loop3_fpga_proto_develop_20260626224036.json |
