...
- generated_at: 2026-06-26T21:25:20
- project: Hi3593_v2
- node: work/loop2_uvm
- level: develop
- change_id: none
...
| docset_sync | FAIL | output/docs/manifests/application_doc_manifest.json source drift: work/gates/gate_status.json; output/docs/manifests/microarchitecture_doc_manifest.json source drift: work/gates/gate_status.json; output/docs/manifests/verification_doc_manifest.json source drift: work/gates/gate_status.json |
...
| path:work/loop2_uvm/trace_matrix/req_to_uvm.yaml | FAIL | missing |
| path:work/loop2_uvm/trace_matrix/req_to_assertion.yaml | FAIL | missing |
| path:work/loop2_uvm/trace_matrix/req_to_coverage.yaml | FAIL | missing |
...
| loop2_transaction_contract | PASS | 60 structured transaction(s) checked |
| loop2_zero_error_counts | PASS | uvm_error=0, uvm_fatal=0, failed_checks=0 |
| loop2_functional_coverage | PASS | 100.00% >= 80.00% |
| loop2_checked_transaction_count | FAIL | 60 checked transaction(s) below minimum 64 |
...
| loop2_code_coverage | FAIL | 59.60% below threshold 80.00% from work/loop2_uvm/current/log/coverage_raw.txt |
...
| review_schema_error | FAIL | Review Agent must cite uvm-env-and-test-build when UVM files exist |
| review_schema_error | FAIL | Review Agent must cite loop2_independent_oracle when reviewing UVM files |
| review_schema_error | FAIL | Review Agent UVM finding must mention every UVM file reviewed: spi_agent.sv, spi_driver.sv, spi_item.sv, spi_monitor.sv, spi_sequencer.sv, dut_assertions.sv, uvm_config.sv, coverage.sv |
