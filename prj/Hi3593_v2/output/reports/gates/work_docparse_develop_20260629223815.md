...
- generated_at: 2026-06-29T22:38:15
- project: Hi3593_v2
- node: work/docparse
- level: develop
...
| forbidden_formal_text | FAIL | forbidden workflow vocabulary found in formal artifact(s): work/docparse/structured_spec/test_intent.yaml |
...
| protected_gate_hash_drift | FAIL | 2 protected gate/platform file change(s) are not covered by CR-20260626224447-complete-hi3593-digital-functional-cover impact artifacts: env/core/hdlflow/reports/parser_hdlflow_events.py, env/tool/scripts/Invoke-HdlLoop3BoardVerify.ps1 |
