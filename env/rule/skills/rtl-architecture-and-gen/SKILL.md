...
- `rtl_semantic_stub_absent` passes, or Arbtr has downgraded the final claim and the RTL is not being treated as full semantic signoff
- `output/docs/test/verification_plan.md` defines the directed TB full-function coverage plan rendered from `work/docparse/verification/verification_plan.yaml`
