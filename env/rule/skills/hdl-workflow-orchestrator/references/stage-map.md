...
- Resume request: read `work/memory/` first, then inspect the latest report and logs.
...
- Token loss or new chat: trust `work/memory/` and `work/docparse/structured_spec/`, not prior conversation.
