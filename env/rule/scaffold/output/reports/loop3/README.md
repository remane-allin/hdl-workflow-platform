...
- [Prototype node](../../../work/loop3_fpga_proto/)
...
must be generated or refreshed from the latest prototype run with
`python -m hdlflow.cli loop3-refresh-reports --project <project>`; do not
