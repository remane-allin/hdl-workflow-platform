# 0 "G:\\EEG\\Workflow\\prj\\eeg_2or8to2or16\\output\\vitis\\p1_eeg_platform\\hw\\sdt\\system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "G:\\EEG\\Workflow\\prj\\eeg_2or8to2or16\\output\\vitis\\p1_eeg_platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "G:\\EEG\\Workflow\\prj\\eeg_2or8to2or16\\output\\vitis\\p1_eeg_platform\\hw\\sdt\\zynq-7000.dtsi" 1
# 10 "G:\\EEG\\Workflow\\prj\\eeg_2or8to2or16\\output\\vitis\\p1_eeg_platform\\hw\\sdt\\zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "G:\\EEG\\Workflow\\prj\\eeg_2or8to2or16\\output\\vitis\\p1_eeg_platform\\hw\\sdt\\system-top.dts" 2
# 1 "G:\\EEG\\Workflow\\prj\\eeg_2or8to2or16\\output\\vitis\\p1_eeg_platform\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  #address-cells = <1>;
  #size-cells = <1>;
  firmware-name = "eeg_bci_ps_pl_system_wrapper.bit.bin";
  clocking0: clocking0 {
  ...
  BCI_0: eeg_bci_ps_axi4_gateway@40000000 {
   xlnx,rable = <0>;
   compatible = "xlnx,eeg-bci-ps-axi4-gateway-1.0";
   status = "okay";
   clock-names = "s_axi_aclk";
   xlnx,ip-name = "eeg_bci_ps_axi4_gateway";
...
# 4 "G:\\EEG\\Workflow\\prj\\eeg_2or8to2or16\\output\\vitis\\p1_eeg_platform\\hw\\sdt\\system-top.dts" 2
# 1 "G:\\EEG\\Workflow\\prj\\eeg_2or8to2or16\\output\\vitis\\p1_eeg_platform\\hw\\sdt\\pcw.dtsi" 1
 &ps7_cortexa9_0 {
  xlnx,rable = <0>;
...
# 5 "G:\\EEG\\Workflow\\prj\\eeg_2or8to2or16\\output\\vitis\\p1_eeg_platform\\hw\\sdt\\system-top.dts" 2
/ {
 device_id = "7z020";
 slrcount = <1>;
 family = "Zynq";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x40000000 &BCI_0 0x40000000 0x4000000>,
